        ...
        <div class="cont">
			...
			<ul class="info_list_cont">
                    ...
                    <div>
                        ...
                        <span class="info_li_3" data-click="0" data-messid="<?php echo $c['id']?>">
                    ...
                    <!--老师申请编辑-->
					<div class="mess_content" id="mess_content_<?php echo $c['id']?>">
...
(function($){
	...
	$(".info_li_3").on("click",function(e) {
		...
		if(click == 0) {
			$(this).data('click',1);
			$("#mess_content_"+messid).show();
		} else {
			$(this).data('click',0);
			$("#mess_content_"+messid).hide();
		}
		// 替换为已读符号
