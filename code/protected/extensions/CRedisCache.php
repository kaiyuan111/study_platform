...
class CRedisCache extends CCache
{
	 ...
	 */
	public $predisPath="application.extensions.CRedisCache";
    /**
	 * @var string list of servers 
	 */
	public $servers=array('host'=>'10.108.72.23','port'=>6379);
	...
	public function getRedis()
	{
		if($this->_cache!==null)
         ...
         return  $this->_cache->connect($this->servers[0]['host'], $this->servers[0]['port']);
		//	return $this->_cache=new Redis($this->servers);
        }
	}
